...
const menuStyles = tv(
    {
        slots: {
            content: [
                "z-50 min-w-[10rem] overflow-hidden rounded-md border border-base/50 bg-white p-1 text-zinc-950 shadow-md  dark:bg-zinc-950 dark:text-zinc-50",
            ...
            separator: "-mx-1 my-1 h-px bg-base",
